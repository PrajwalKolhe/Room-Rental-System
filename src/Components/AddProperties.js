...
export default class AddProperties extends React.Component{
    ...
    margin: '100px  300px 100px 300px'}}>
            ...
            <div className="form-group">
                ...
                <div className="mb-3">
                    <select className="form-select" required aria-label="select example" name="pr_type" onChange={this.handleChange}>
                ...
                <div className="mb-3">
                    <select className="form-select" required aria-label="select example" name="city" onChange={this.handleChange}>
                ...
                <div className="mb-3">
                    <select class="form-select" required aria-label="select example" name="area" onChange={this.handleChange}>
                  ...
                  <div className="invalid-feedback">Please select Area</div>
                </div>
                ...
                <div className="mb-3">
                    <select class="form-select" required aria-label="select example" name="user" onChange={this.handleChange}>
                ...
                <div className="form-group">
                    ...
                    <input type="number" id="rent" minLength="4" ref="rent"  name="rent" className="form-control" onChange={this.handleChange} ></input>
                ...
                <div className="form-group">
                    ...
                    <input type="number" id="brokerage" ref="brokerage"  name="brokerage" className="form-control" onChange={this.handleChange} ></input>

                </div>
        
                <div className="form-group">
                    <label style={{color:'lightcoral'}} for="facilities" style={{textAlign:'left'}}><b>Facilities Available:</b></label> 
                    <input type="text" id="facilties" ref="facilities"  name="facilities" className="form-control" onChange={this.handleChange} ></input>
                </div>
